...
def draw_matrix(matrix, data_color_match, grid_x, grid_y, grid_width: int, grid_height: int, margin_size, margin_color,
    ...
    cells_positions = cells_positions_list(grid_x, grid_y, grid_width, grid_height, rows, columns, margin_size)
